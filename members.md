...
<div style="display: flex; align-items: flex-start; margin-bottom: 3rem; padding: 1.5rem; background: #f8f9fa; border-radius: 8px;">
  ...
  <div style="flex-grow: 1;">
    <h3 style="margin-top: 0; color: #2c3e50; display: flex; align-items: center;">
      <a href="https://www.linkedin.com/in/bingxia-wang/" target="_blank" style="text-decoration: none; color: #2c3e50;">Bingxia Wang</a>
...
<div style="display: flex; align-items: flex-start; margin-bottom: 3rem; padding: 1.5rem; background: #f8f9fa; border-radius: 8px;">
  ...
  <div style="flex-grow: 1;">
    <h3 style="margin-top: 0; color: #2c3e50;">
      <a href="[https://www.linkedin.com/in/heng-wang/](https://www.linkedin.com/in/heng-wang-52a19265/)" target="_blank" style="text-decoration: none; color: #2c3e50;">Heng Wang</a>
    </h3>
    <p style="margin-bottom: 1.5rem; line-height: 1.6;">
